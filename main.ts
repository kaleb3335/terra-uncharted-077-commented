    ...
    if (inmenu == 0) {
        if (inbuild == 1) {
            ...
            myMenu = miniMenu.createMenu(miniMenu.createMenuItem("dirt", assets.tile`
                    ...
                    myTile18
                    `), miniMenu.createMenuItem("wood ceiling", assets.tile`
                    myTile23
                    `), miniMenu.createMenuItem("wood roof", assets.tile`
                    myTile21
                    `))
            myMenu.setDimensions(120, 100)
            myMenu.setTitle("Building")
            myMenu.setMenuStyleProperty(miniMenu.MenuStyleProperty.ScrollIndicatorColor, 3)
            myMenu.x = 60
            myMenu.y = 80
            myMenu.setFlag(SpriteFlag.RelativeToCamera, true)
            myMenu.onButtonPressed(controller.A, function on_button_pressed(selection2: any, selectedIndex2: any) {
                ...
                if (selectedIndex2 == 0) {
                    ...
                    if (wood >= 1) {
                        ...
                        game.showLongText("you do not have wood", DialogLayout.Bottom)
                    }
                    ...
                    if (wood_roof >= 1) {
                        timer.after(500, function on_after8() {
                            
                            buildM = 7
                        })
                    } else {
                        game.showLongText("you do not have wood roof", DialogLayout.Bottom)
                    }
...
function make_trees(num: number) {
    ...
    for (let value8 of tiles.getTilesByType(assets.tile`
        ...
        if (tiles.tileAtLocationEquals(value8.getNeighboringLocation(CollisionDirection.Top), assets.tile`
                transparency16
                `)) {
            if (Math.percentChance(randint(45, 75))) {
    ...
    for (let value113 of tiles.getTilesByType(assets.tile`
        myTile80
        `)) {
        if (tiles.tileAtLocationEquals(value113.getNeighboringLocation(CollisionDirection.Right), assets.tile`
                transparency16
                `)) {
            tiles.setTileAt(value113.getNeighboringLocation(CollisionDirection.Right), assets.tile`
                    myTile78
                    `)
        }
    ...
    for (let value114 of tiles.getTilesByType(assets.tile`
        myTile80
        `)) {
        if (tiles.tileAtLocationEquals(value114.getNeighboringLocation(CollisionDirection.Left), assets.tile`
                transparency16
                `)) {
            tiles.setTileAt(value114.getNeighboringLocation(CollisionDirection.Left), assets.tile`
                    myTile77
                    `)
        }
    ...
    for (let value115 of tiles.getTilesByType(assets.tile`
        myTile74
        `)) {
        if (tiles.tileAtLocationEquals(value115.getNeighboringLocation(CollisionDirection.Top), assets.tile`
                transparency16
                `)) {
            tiles.setTileAt(value115.getNeighboringLocation(CollisionDirection.Top), assets.tile`
                    myTile80
                    `)
        }
    ...
    for (let value119 of tiles.getTilesByType(assets.tile`
        myTile81
        `)) {
        if (tiles.tileAtLocationEquals(value119.getNeighboringLocation(CollisionDirection.Right), assets.tile`
                transparency16
                `)) {
            tiles.setTileAt(value119.getNeighboringLocation(CollisionDirection.Right), assets.tile`
                    myTile83
                    `)
        }
    ...
    for (let value1110 of tiles.getTilesByType(assets.tile`
        myTile81
        `)) {
        if (tiles.tileAtLocationEquals(value1110.getNeighboringLocation(CollisionDirection.Left), assets.tile`
                transparency16
                `)) {
            tiles.setTileAt(value1110.getNeighboringLocation(CollisionDirection.Left), assets.tile`
                    myTile82
                    `)
        }
    ...
    for (let value84 of tiles.getTilesByType(assets.tile`
        ...
        if (tiles.tileAtLocationEquals(value84.getNeighboringLocation(CollisionDirection.Top), assets.tile`
                transparency16
                `)) {
            if (Math.percentChance(randint(40, 75))) {
    ...
    for (let value1111 of tiles.getTilesByType(assets.tile`
        myTile87
        `)) {
        if (tiles.tileAtLocationEquals(value1111.getNeighboringLocation(CollisionDirection.Top), assets.tile`
                transparency16
                `)) {
            tiles.setTileAt(value1111.getNeighboringLocation(CollisionDirection.Top), assets.tile`
                    myTile95
                    `)
        }
        
    }
    for (let value122 of tiles.getTilesByType(assets.tile`
        myTile95
        `)) {
        if (tiles.tileAtLocationEquals(value122.getNeighboringLocation(CollisionDirection.Right), assets.tile`
                transparency16
                `)) {
            tiles.setTileAt(value122.getNeighboringLocation(CollisionDirection.Right), assets.tile`
                    myTile94
                    `)
        }
        
        if (tiles.tileAtLocationEquals(value122.getNeighboringLocation(CollisionDirection.Left), assets.tile`
                transparency16
                `)) {
            tiles.setTileAt(value122.getNeighboringLocation(CollisionDirection.Left), assets.tile`
                    myTile96
                    `)
        }
        
    }
    for (let value85 of tiles.getTilesByType(assets.tile`
        myTile65
        `)) {
        if (tiles.tileAtLocationEquals(value85.getNeighboringLocation(CollisionDirection.Top), assets.tile`
                transparency16
                `)) {
            if (Math.percentChance(randint(45, 80))) {
                tiles.setTileAt(value85.getNeighboringLocation(CollisionDirection.Top), assets.tile`
                        myTile67
                        `)
            }
    ...
    for (let index7 = 0; index7 < 3; index7++) {
        for (let index8 = 0; index8 < randint(1, 4); index8++) {
            ...
            for (let value106 of tiles.getTilesByType(assets.tile`
                myTile69
                `)) {
                if (tiles.tileAtLocationEquals(value106.getNeighboringLocation(CollisionDirection.Top), assets.tile`
                        transparency16
                        `)) {
                    if (Math.percentChance(50)) {
                        tiles.setTileAt(value106.getNeighboringLocation(CollisionDirection.Top), assets.tile`
                                myTile67
                                `)
                    }
    ...
    for (let value1112 of tiles.getTilesByType(assets.tile`
        myTile67
        `)) {
        if (tiles.tileAtLocationEquals(value1112.getNeighboringLocation(CollisionDirection.Top), assets.tile`
                transparency16
                `)) {
            tiles.setTileAt(value1112.getNeighboringLocation(CollisionDirection.Top), assets.tile`
                    myTile68
                    `)
        }
        
    }
    for (let value1113 of tiles.getTilesByType(assets.tile`
        myTile69
        `)) {
        if (tiles.tileAtLocationEquals(value1113.getNeighboringLocation(CollisionDirection.Top), assets.tile`
                transparency16
                `)) {
            tiles.setTileAt(value1113.getNeighboringLocation(CollisionDirection.Top), assets.tile`
                    myTile68
                    `)
        }
...
function makeplayer() {
    ...
    player_health.setPosition(20, 3)
    scene.cameraFollowSprite(player1)
    stats.turnStats(true)
    world = 0
    if (secworld == 1) {
        tiles.setCurrentTilemap(tilemaps[world])
    } else {
...
function make_underworld() {
    ...
    for (let index9 = 0; index9 < 16; index9++) {
        tiles.setTileAt(tiles.getTileLocation(col, 245), assets.tile`
                myTile3
                `)
        col += 16
    }
    for (let index10 = 0; index10 < 16; index10++) {
    ...
    for (let index11 = 0; index11 < 10; index11++) {
    ...
    for (let index12 = 0; index12 < 25; index12++) {
    ...
    col = 0
    for (let index13 = 0; index13 < 255; index13++) {
        if (tiles.tileAtLocationEquals(tiles.getTileLocation(col, 240), assets.tile`
                transparency16
                `)) {
            tiles.setTileAt(tiles.getTileLocation(col, 240), assets.tile`
                    myTile50
                    `)
        }
    ...
    for (let index14 = 0; index14 < 15; index14++) {
        for (let value6322 of tiles.getTilesByType(assets.tile`
            ...
            if (tiles.tileAtLocationEquals(value6322.getNeighboringLocation(CollisionDirection.Right), assets.tile`
                    transparency16
                    `)) {
                tiles.setTileAt(value6322.getNeighboringLocation(CollisionDirection.Right), assets.tile`
                        myTile44
                        `)
            }
            
            if (tiles.tileAtLocationEquals(value6322.getNeighboringLocation(CollisionDirection.Left), assets.tile`
                    transparency16
                    `)) {
                tiles.setTileAt(value6322.getNeighboringLocation(CollisionDirection.Left), assets.tile`
                        myTile44
                        `)
            }
    ...
    for (let value922 of tiles.getTilesByType(assets.tile`
        myTile43
        `)) {
        if (tiles.tileAtLocationEquals(value922.getNeighboringLocation(CollisionDirection.Top), assets.tile`
                transparency16
                `)) {
            tiles.setTileAt(value922.getNeighboringLocation(CollisionDirection.Top), assets.tile`
                    myTile41
                    `)
        }
    ...
    for (let index15 = 0; index15 < 2; index15++) {
        for (let index16 = 0; index16 < randint(1, 4); index16++) {
...
function make_caves() {
    statusbar.value += load_p
    pause(100)
    for (let index17 = 0; index17 < 40; index17++) {
        for (let index18 = 0; index18 < randint(0, 4); index18++) {
...
controller.menu.onEvent(ControllerButtonEvent.Pressed, function on_menu_pressed() {
    ...
    if (inmenu == 0) {
        ...
        gamemenu.onButtonPressed(controller.A, function on_button_pressed2(selection3: any, selectedIndex3: any) {
            ...
            if (selectedIndex3 == 0) {
                ...
                if (inmenu == 0) {
                    inmenu = 1
                    sprites.destroyAllSpritesOfKind(SpriteKind.MiniMenu)
                    myMenu = miniMenu.createMenu(miniMenu.createMenuItem("dirt= " + ("" + ("" + dirt))), miniMenu.createMenuItem("stone= " + ("" + ("" + stone))), miniMenu.createMenuItem("blk stone= " + ("" + ("" + blk_stone))), miniMenu.createMenuItem("sticks= " + ("" + ("" + sticks))), miniMenu.createMenuItem("wood= " + ("" + ("" + wood))), miniMenu.createMenuItem("treeseeds " + ("" + ("" + treeseed))))
                    myMenu.setDimensions(100, 80)
                    myMenu.x = 60
                    myMenu.y = 40
                    myMenu.setFlag(SpriteFlag.RelativeToCamera, true)
                    myMenu.onButtonPressed(controller.A, function on_button_pressed3(selection4: any, selectedIndex4: any) {
                ...
                if (inmenu == 0) {
                    ...
                    myMenu.y = 40
                    myMenu.setFlag(SpriteFlag.RelativeToCamera, true)
                    myMenu.onButtonPressed(controller.A, function on_button_pressed4(selection42: any, selectedIndex42: any) {
                        ...
                        if (selectedIndex42 == 0) {
                            ...
                            myMenu.y = 40
                            myMenu.setFlag(SpriteFlag.RelativeToCamera, true)
                            myMenu.onButtonPressed(controller.A, function on_button_pressed5(selection43: any, selectedIndex43: any) {
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`
    ...
    while (player1.tilemapLocation() == location4) {
        sprite4.y += -0.01
    }
    if (sprite4.isHittingTile(CollisionDirection.Right) || sprite4.isHittingTile(CollisionDirection.Left)) {
        sprite4.y += -3
    }
...
function make_stone() {
    ...
    for (let index27 = 0; index27 < 16; index27++) {
    ...
    for (let index28 = 0; index28 < 16; index28++) {
    ...
    for (let value2222 of tiles.getTilesByType(assets.tile`
        myTile16
        `)) {
        if (tiles.tileAtLocationEquals(value2222.getNeighboringLocation(CollisionDirection.Bottom), assets.tile`
                transparency16
                `)) {
            if (Math.percentChance(65)) {
                tiles.setTileAt(value2222.getNeighboringLocation(CollisionDirection.Bottom), assets.tile`
                        myTile55
                        `)
            }
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`
        myTile63
        `, function on_overlap_tile6(sprite23: Sprite, location23: tiles.Location) {
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`
        transparency16
        `, function on_overlap_tile7(sprite5: Sprite, location5: tiles.Location) {
    if (location5.column == 0 && (characterAnimations.matchesRule(player1, characterAnimations.rule(Predicate.MovingLeft)) && secworld == 1)) {
        timer.throttle("action", 500, function on_throttle() {
            
            if (world >= tilemaps.length - 1) {
                world = 0
            } else {
                world += 1
            }
            ...
            tileUtil.setTileAt(tileUtil.currentTilemap(), tiles.getTileLocation(254, player1.tilemapLocation().row), assets.tile`
                    transparency16
                    `)
            tileUtil.setTileAt(tileUtil.currentTilemap(), tiles.getTileLocation(254, player1.tilemapLocation().row + 1), assets.tile`
                    transparency16
                    `)
            tileUtil.setWallAt(tileUtil.currentTilemap(), tiles.getTileLocation(254, player1.tilemapLocation().row), false)
            tileUtil.setWallAt(tileUtil.currentTilemap(), tiles.getTileLocation(254, player1.tilemapLocation().row + 1), false)
        })
    } else if (location5.column == 254 && (characterAnimations.matchesRule(player1, characterAnimations.rule(Predicate.MovingRight)) && secworld == 1)) {
        timer.throttle("action", 500, function on_throttle2() {
            
            if (world <= 0) {
                world = tilemaps.length - 1
            } else {
                world += -1
            }
            ...
            tileUtil.setTileAt(tileUtil.currentTilemap(), tiles.getTileLocation(0, player1.tilemapLocation().row), assets.tile`
                    transparency16
                    `)
            tileUtil.setTileAt(tileUtil.currentTilemap(), tiles.getTileLocation(0, player1.tilemapLocation().row + 1), assets.tile`
                    transparency16
                    `)
            tileUtil.setWallAt(tileUtil.currentTilemap(), tiles.getTileLocation(0, player1.tilemapLocation().row), false)
            tileUtil.setWallAt(tileUtil.currentTilemap(), tiles.getTileLocation(0, player1.tilemapLocation().row + 1), false)
        })
    }
...
function make_dirt() {
    ...
    if (Math.percentChance(25)) {
        ...
        for (let index30 = 0; index30 < 6; index30++) {
            tiles.setTileAt(tiles.getTileLocation(col, 64), assets.tile`
                    myTile1
                    `)
            col += 16
        }
        for (let index31 = 0; index31 < 6; index31++) {
            tiles.setTileAt(tiles.getTileLocation(col, 64), assets.tile`
                    myTile64
                    `)
            col += 16
        ...
        for (let index34 = 0; index34 < 8; index34++) {
            tiles.setTileAt(tiles.getTileLocation(col, 64), assets.tile`
                    myTile1
                    `)
            col += 16
        }
        for (let index35 = 0; index35 < 8; index35++) {
            col += 16
            tiles.setTileAt(tiles.getTileLocation(col, 64), assets.tile`
                    myTile61
                    `)
        ...
        for (let index37 = 0; index37 < 6; index37++) {
            tiles.setTileAt(tiles.getTileLocation(col, 64), assets.tile`
                    myTile64
                    `)
            col += 16
        }
        for (let index38 = 0; index38 < 6; index38++) {
            tiles.setTileAt(tiles.getTileLocation(col, 64), assets.tile`
                    myTile61
                    `)
            col += 16
    ...
    for (let index40 = 0; index40 < 16; index40++) {
        if (biomes == 1) {
    ...
    for (let index41 = 0; index41 < 16; index41++) {
    ...
    if (biomes >= 3) {
        ...
        for (let index42 = 0; index42 < 25; index42++) {
...
scene.setBackgroundImage(img`
    ...
    `)
myMenu2.onButtonPressed(controller.A, function on_button_pressed6(selection: any, selectedIndex: any) {
    ...
    if (selectedIndex == 0) {
        ...
        myMenu2 = miniMenu.createMenu(miniMenu.createMenuItem("4 sections"), miniMenu.createMenuItem("6 sections"), miniMenu.createMenuItem("8 sections"), miniMenu.createMenuItem("custom size"))
        myMenu2.onButtonPressed(controller.A, function on_button_pressed7(selection5: any, selectedIndex5: any) {
            ...
            if (selectedIndex5 == 0) {
                load_p = 100 / 32
                for (let index43 = 0; index43 < 4; index43++) {
                    tiles.setCurrentTilemap(tilemaps[world])
                    world_gen()
                    world += 1
                }
                ...
                load_p = 100 / 48
                for (let index44 = 0; index44 < 2; index44++) {
                    tilemaps.push(tilemap`
                        level4
                        `)
                }
                for (let index45 = 0; index45 < 6; index45++) {
                    tiles.setCurrentTilemap(tilemaps[world])
                    world_gen()
                    world += 1
                }
                ...
                load_p = 100 / 64
                for (let index46 = 0; index46 < 4; index46++) {
                    tilemaps.push(tilemap`
                        level4
                        `)
                }
                for (let index47 = 0; index47 < 8; index47++) {
                    tiles.setCurrentTilemap(tilemaps[world])
                    world_gen()
                    world += 1
                }
                ...
                secnum = game.askForNumber("how many sections do you want", 2)
                if (game.ask("you want " + ("" + ("" + secnum) + "sections"))) {
                    load_p = 100 / (8 * secnum)
                    tilemaps = []
                    for (let index48 = 0; index48 < secnum; index48++) {
                        tilemaps.push(tilemap`
                            level4
                            `)
                    }
                    for (let index49 = 0; index49 < secnum; index49++) {
                        tiles.setCurrentTilemap(tilemaps[world])
                        world_gen()
                        world += 1
                    }
    ...
    if (world_gen_done == 1) {
        if (player1.y <= 2000) {
            for (let value14 of tiles.getTilesByType(assets.tile`
                myTile32
                `)) {
                if (tiles.tileAtLocationEquals(value14.getNeighboringLocation(CollisionDirection.Top), assets.tile`
                        transparency16
                        `)) {
                    tiles.setTileAt(value14.getNeighboringLocation(CollisionDirection.Top).getNeighboringLocation(CollisionDirection.Bottom), assets.tile`
                            transparency16
                            `)
                }
...
forever(function on_forever5() {
    if (world_gen_done == 1) {
        ...
        if (player1.y <= 2000) {
            if (tiles.tileAtLocationEquals(tiles.getTileLocation(player1.tilemapLocation().column, 64), assets.tile`
                    myTile15
                    `) || tiles.tileAtLocationEquals(tiles.getTileLocation(player1.tilemapLocation().column, 64), assets.tile`
                    myTile1
                    `)) {
                scene.setBackgroundImage(img`
                    
                    ...
                    
                    `)
            } else if (tiles.tileAtLocationEquals(tiles.getTileLocation(player1.tilemapLocation().column, 64), assets.tile`
                    myTile65
                    `) || tiles.tileAtLocationEquals(tiles.getTileLocation(player1.tilemapLocation().column, 64), assets.tile`
                    myTile64
                    `)) {
            ...
            if (inmenu == 0 && inbuild == 0) {
                if (tiles.tileAtLocationEquals(select.tilemapLocation(), assets.tile`
                    ...
                    timer.throttle("action", 500, function on_throttle3() {
                        ...
                        inmenu = 1
                        myMenu = miniMenu.createMenu(miniMenu.createMenuItem("stone wall", assets.tile`
                                myTile8
                                `), miniMenu.createMenuItem("blk stone wall", assets.tile`
                                myTile7
                                `), miniMenu.createMenuItem("wooden backing", assets.tile`
                                myTile17
                                `), miniMenu.createMenuItem("wooden floor", assets.tile`
                                myTile18
                                `), miniMenu.createMenuItem("wooden ceiling", assets.tile`
                                myTile23
                                `), miniMenu.createMenuItem("wooden roof", assets.tile`
                                myTile21
                                `))
                        myMenu.setTitle("crafting")
                        myMenu.y = 80
                        myMenu.x = 55
                        myMenu.setFlag(SpriteFlag.RelativeToCamera, true)
                        myMenu.onButtonPressed(controller.A, function on_button_pressed8(selection52: any, selectedIndex52: any) {
                            
                            if (selectedIndex52 == 0) {
                                if (stone >= 15) {
                                    stone_wall += 3
                                    stone += -15
                                    player1.sayText("Crafted 3 stone walls")
                                } else {
                                    game.showLongText("you do not have stone (15) ", DialogLayout.Bottom)
                                }
                                
                            } else if (selectedIndex52 == 1) {
                                if (blk_stone >= 15) {
                                    blk_stone_wall += 3
                                    blk_stone += -15
                                    player1.sayText("crafted 3 black stone walls")
                                } else {
                                    game.showLongText("you do not have black stone (15)", DialogLayout.Bottom)
                                }
                                
                            } else if (selectedIndex52 == 2) {
                                if (wood >= 15) {
                                    wdBacking += 3
                                    wood += -15
                                    player1.sayText("crafted 3 wood backing")
                                } else {
                                    game.showLongText("you do not have wood (15)", DialogLayout.Bottom)
                                }
                                
                            } else if (selectedIndex52 == 3) {
                                if (wood >= 15) {
                                    wdfloor += 3
                                    wood += -15
                                    player1.sayText("crafted 3 wood floors")
                                } else {
                                    game.showLongText("you do not have wood (15)", DialogLayout.Bottom)
                                }
                                
                            } else if (selectedIndex52 == 4) {
                                if (wood >= 15) {
                                    wdciling += 3
                                    wood += -15
                                    player1.sayText("crafted 3 wood ceiling")
                                } else {
                                    game.showLongText("you do not have wood (15)", DialogLayout.Bottom)
                                }
                                
                            } else if (selectedIndex52 == 5) {
                                if (wood >= 15) {
                                    wood_roof += 3
                                    wood += -15
                                    player1.sayText("crafted 3 wood roofs")
                                } else {
                                    game.showLongText("you do not have wood (15)", DialogLayout.Bottom)
                                }
    ...
    if (world_gen_done == 1) {
        if (tiles.tileAtLocationEquals(player1.tilemapLocation(), assets.tile`
            ...
            timer.throttle("action", 500, function on_throttle11() {
                ...
                controller.moveSprite(player1, 20, 20)
            })
        } else {
            player1.ay = 500
            if (inmenu == 0) {
            ...
            if (inbuild == 0) {
                if (tiles.tileAtLocationEquals(select.tilemapLocation(), assets.tile`
                    ...
                    timer.throttle("action", 500, function on_throttle13() {
                        ...
                        `)))))))))))))) {
                    location6 = 0
                    timer.throttle("action", location6, function on_throttle14() {
                    ...
                    if (tiles.tileAtLocationEquals(select.tilemapLocation().getNeighboringLocation(CollisionDirection.Bottom), assets.tile`
                            myTile31
                            `) || (tiles.tileAtLocationEquals(select.tilemapLocation().getNeighboringLocation(CollisionDirection.Bottom), assets.tile`
                            myTile29
                            `) || tiles.tileAtLocationEquals(select.tilemapLocation().getNeighboringLocation(CollisionDirection.Bottom), assets.tile`
                            myTile4
                            `))) {
                        tiles.setTileAt(select.tilemapLocation().getNeighboringLocation(CollisionDirection.Bottom), assets.tile`
                                transparency16
                                `)
                    } else {
                    ...
                    tiles.setTileAt(select.tilemapLocation(), assets.tile`
                            ...
                            `)
                    dirt += randint(1, 3)
                    timer.throttle("action", 500, function on_throttle19() {
...
game.onUpdateInterval(20000, function on_update_interval2() {
    if (world_gen_done == 1) {
        if (player1.y <= 2000) {
            ...
            for (let value143 of tiles.getTilesByType(assets.tile`
                ...
                if (tiles.tileAtLocationEquals(value143.getNeighboringLocation(CollisionDirection.Bottom), assets.tile`
                        ...
                        `)) {
                    if (Math.percentChance(50)) {
                        tiles.setTileAt(value143.getNeighboringLocation(CollisionDirection.Bottom), assets.tile`
                                myTile4
                                `)
                    }
        ...
        if (player1.y >= 3000) {
            for (let value144 of tiles.getTilesByType(assets.tile`
                myTile55
                `)) {
                if (tiles.tileAtLocationEquals(value144.getNeighboringLocation(CollisionDirection.Bottom), assets.tile`
                        myTile54
                        `) || tiles.tileAtLocationEquals(value144.getNeighboringLocation(CollisionDirection.Bottom), assets.tile`
                        transparency16
                        `)) {
                    if (Math.percentChance(25)) {
                        tileUtil.coverTile(value144.getNeighboringLocation(CollisionDirection.Bottom), assets.tile`
                                myTile48
                                `)
                    }
